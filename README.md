...
LSPs and standalone tools are installed via [mise](https://mise.jdx.dev/) in
[dev.containerfile](env/dev/dev.containerfile), while linter/formatter plugins
are managed through [package.json](package.json).

| Language                                                              | LSP                                                                                                    | Linter                                                                                                                                                                                                                                                    | Formatter                                                                                                      |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [TypeScript](https://www.typescriptlang.org/)                         | [typescript-language-server](https://github.com/typescript-language-server/typescript-language-server) | [ESLint](https://eslint.org/) ([@typescript-eslint](https://typescript-eslint.io/)) + [@astrojs/check](https://www.npmjs.com/package/@astrojs/check)                                                                                                      | [Prettier](https://prettier.io/)                                                                               |
...
| [Astro](https://astro.build/)                                         | [@astrojs/language-server](https://github.com/withastro/language-tools)                                | [ESLint](https://eslint.org/) ([eslint-plugin-astro](https://github.com/ota-meshi/eslint-plugin-astro) + [eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)) + [@astrojs/check](https://www.npmjs.com/package/@astrojs/check) | [Prettier](https://prettier.io/) + [prettier-plugin-astro](https://github.com/withastro/prettier-plugin-astro) |
...
| [Markdown](https://www.markdownguide.org/)                            | -                                                                                                      | [markdownlint-cli2](https://github.com/DavidAnson/markdownlint-cli2)                                                                                                                                                                                      | [Prettier](https://prettier.io/)                                                                               |
| [YAML](https://yaml.org/)                                             | [yaml-language-server](https://github.com/redhat-developer/yaml-language-server)                       | [ESLint](https://eslint.org/) ([eslint-plugin-yml](https://github.com/ota-meshi/eslint-plugin-yml))                                                                                                                                                       | [Prettier](https://prettier.io/)                                                                               |
| [TOML](https://toml.io/)                                              | [taplo](https://taplo.tamasfe.dev/)                                                                    | [taplo lint](https://taplo.tamasfe.dev/)                                                                                                                                                                                                                  | [taplo fmt](https://taplo.tamasfe.dev/)                                                                        |
...
| [Fish](https://fishshell.com/)                                        | -                                                                                                      | [fish --no-execute](https://fishshell.com/docs/current/cmds/fish.html)                                                                                                                                                                                    | [fish_indent](https://fishshell.com/docs/current/cmds/fish_indent.html)                                        |
| [Dockerfile](https://docs.docker.com/reference/dockerfile/)           | [dockerfile-language-server](https://github.com/rcjsuen/dockerfile-language-server-nodejs)             | [hadolint](https://github.com/hadolint/hadolint)                                                                                                                                                                                                          | [dockerfmt](https://github.com/reteps/dockerfmt)                                                               |
| [Caddyfile](https://caddyserver.com/docs/caddyfile)                   | -                                                                                                      | [caddy validate](https://caddyserver.com/docs/command-line#caddy-validate)                                                                                                                                                                                | [caddy fmt](https://caddyserver.com/docs/command-line#caddy-fmt)                                               |
...
Custom CSS - Native CSS3 with no frameworks or libraries
...
**Native web technologies only** - This project uses vanilla HTML, CSS, and
JavaScript/TypeScript. No UI frameworks (React, Vue, Svelte) or CSS frameworks
(Tailwind, Bootstrap) are used. Astro serves purely as a static site generator.
